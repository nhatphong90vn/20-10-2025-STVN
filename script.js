...
const SHARED_QUESTIONS = [
    ...
    },
    {
        ...
        options: ["Xương và thịt", "Trà sữa và cảm xúc", "Không khí", "DNA và tâm hồn"],
    ...
    },
    {
        ...
        options: ["Khi nhẹ hơn nước", "Khi có lỗ thoát khí", "Khi được phù hộ", "Khi làm bằng cao su"],
...
const GOOGLE_SHEETS_CONFIG = {
    ...
    scriptUrl: 'https://script.google.com/macros/s/AKfycbwnUx9_KjM3-SM2KTI8pnE2pMteLX-1YwpTdcNpCc6RXg9ez7muaP1p7rMDwyEr5SzZ/exec',
...
function startGame() {
    ...
    document.getElementById('current-character-role').textContent = character.role;
...
async function displayLeaderboard(tab = 'time') {
    ...
    leaderboardList.innerHTML = '<div style="text-align: center; padding: 20px; color: #666;"><i class="fas fa-spinner fa-spin"></i> Đang tải dữ liệu...</div>';
    ...
    try {
        ...
        if (sortedLeaderboard.length === 0) {
            leaderboardList.innerHTML = '<div style="text-align: center; padding: 40px; color: #666;">Chưa có kết quả nào!</div>';
        } else {
                ...
                leaderboardItem.innerHTML = `
                    ...
                    <div class="player-info">
                        ...
                        <div class="player-stats">
                            ${entry.correct}/10 câu đúng • ${10 - entry.correct}/10 câu sai • ${entry.time}s • ${entry.date}
                        </div>
                    </div>
