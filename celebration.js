...
function initializeCelebration() {
    ...
    const elements = document.querySelectorAll('.character-section, .message-box, .celebration-actions');
...
function startConfettiAnimation() {
    ...
    for (let i = 0; i < 50; i++) {
        setTimeout(() => {
            ...
            // Random colors
            const colors = ['#ff6b9d', '#ff8fab', '#ffd700', '#4CAF50', '#2196F3', '#9C27B0', '#FF9800', '#E91E63'];
